...
/**
 * This is the model class for table "cid".
 *
 * The followings are the available columns in table 'cid':
...
class Cid extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cid_id, codigo, descr', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'benefs' => array(self::HAS_MANY, 'Benef', 'cid_id'),
		);
	}
